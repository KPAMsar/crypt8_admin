...
import { getDigitalCurrency,addDigitalCurrency, deleteDigitalCurrency } from "../../features/api/digital-currency/digitalCurrencyApi";
...
const DashboardDigitalCurrency = () => {
  ...
  const fetchAllDigitalCurrency = async () => {
    ...
    try {
        ...
        setRotate(false);
        setDigitalCurrency(data?.cryptos)
...
const handleAddDigitalCurrency = async (e) => {
    e.preventDefault();
...
// console.log('currencyy',currencyImage)
    ...
    try {
      const response = await addDigitalCurrency(formData);
...
const handleDelete = async (e) => {
    ...
    try {
        ...
        const data = await deleteDigitalCurrency(selectedId); 
          console.log(data);
    } catch (error) {
        console.error(error);
        return error;
                      ...
                      <tbody className='bg-[#0E0E0E]  '>
                          {digitalCurrency.map((items, index) => (
                              <tr style={{ border: 'none', justifyItems: ' center' }}>
                                  ...
                                  <td style={{ border: 'none' }} className='p-[1rem]   mx-auto text-[#787878]'>
                ...
                <div className="p-3 w-full">
                    ...
                    <div>
                        ...
                        <div className="flex  flex-col gap-4 ">
                            <form onSubmit={handleAddDigitalCurrency} encType="multipart/form-data">
              ...
              <div>
                ...
                <div className="modal">
                    ...
                    <div className="modal-content flex flex-col gap-5 bg-[#262626]">
                        ...
                        <span className='text-[white]'>Are you sure you want to delete item?</span>
