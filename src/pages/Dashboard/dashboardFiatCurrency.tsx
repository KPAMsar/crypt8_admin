...
import {
  ...
  updateFiatCurrency,
  deleteFiatCurrency,
} from "../../features/api/fiat-currency/fiatCurrencyApi";
  ...
  return (
    <>
      <div className="lg:mb-[6rem] w-[100dvw] lg:w-[100%] overflow-hidden md:pl-[30px] pr-[10px] pl-[10px] md:pr-[30px] lg:pl-[48px] mt-[100px] lg:mt-[100px] lg:pr-[40px]">
        <div>
          <p className=" text-[white] pb-[78px] text-[20px] font-[600]">
            All Fiat Currency
          </p>
        </div>
        ...
        <div className="lg:bg-[#0E0E0E]">
          <div className="flex justify-between lg:p-[35px] pb-[10px]">
            ...
            <p
              ...
              className="text-[#9CFA4A]  p-2 lg:px-[150px] px-[90px] py-[15px] lg:py-4  border border-1 border-[#9CFA4A2B]   bg-[#9CFA4A2B]  "
              onClick={() => {
                setShow(true);
                initModal();
              }}
                ...
                {fiatCurrency.map((items, index) => (
                  <tr style={{ border: "none", justifyItems: " center" }}>
                    ...
                    <td
                      ...
                      className="p-[1rem]  text-[#787878]"
                    >
                      {items?.status === "1" ? "Successful" : "Pending"}
                    </td>
                    <td
                      style={{ border: "none" }}
                      className="p-[1rem]  text-[#787878]"
                    >
                      <button
                        className="btn mx-auto block bg-[#9CFA4A2B] text-[#9CFA4A]"
                        onClick={() => {
                          setUpdate(true);
   ...
   bg-[#DA0808] text-[#f0a9a9]"
        ...
        <div className="p-3 w-full">
          ...
          <div>
            ...
            <div className="flex  flex-col gap-4 ">
              <form
                onSubmit={handleAddFiatCurrency}
              ...
              >
                <div className="bg-[#0E0E0E]">
                  ...
                  <input
                    ...
                    name="currencyName"
                    value={currencyName}
                    className=" bg-[#0E0E0E]  text-[white]  lg:h-[60px] h-[50px] mb-[30px]  justify-between flex flex-col justify-item p-4 lg:p-4 gap-3 w-[100%] h-[120px]"
                    onChange={(e) => {
                ...
                <div className=" bg-[#0E0E0E] justify-between h-[90px] flex flex-col justify-item p-4 mb-3 lg:p-4 gap-1 lg:gap-3 w-[100%]">
                  ...
                  <div className="  justify-center">
                    <label htmlFor="app">
                      ...
                      <p
                        className={`${
                          imageName ? " w-[auto]" : "w-[110px]"
                        } text-white text-[16px] border  border-[#9CFA4A] p-[7px] rounded-lg`}
                      >
                        {!imageName ? "Choose File" : imageName}
                      </p>
                    </label>
                  </div>
                </div>
      ...
      <div
        className={`h-[100dvh]  items-center w-[95%]   md:w-[500px] rounded-lg lg:h-[854px] lg:w-[749px]  lg:absolute lg:right-[0px] flex justify-center lg:justify-items-end bg-[#010101]  shadow-lg   z-30 lg:backdrop-blur-md backdrop-blur-md fixed top-2 lg:top-4    lg:right-[0%] right-[2.5%] lg:right-7 transform ${
          update ? "translate-y-0" : "-translate-y-[-200%] "
        } transition-transform duration-300 ease-in-out pb-[30px]`}
      >
        {/* modal content goes here */}
        <div className="p-3 w-full">
      ...
      <div>
        ...
        <div className="modal">
          ...
          <div
            className={`modal-content flex flex-col gap-5 bg-[#262626] ${
              deleteing ? "w-[380px] " : "w-auto"
            }`}
          >
            <label
              htmlFor="modal-1"
            ...
            {!deleteing && (
              <div className="flex gap-3">
                <button
                  className="btn btn-error btn-block bg-[#DA0808] "
