        ...
        <>
            <div className=" lg:mb-[6rem] w-[100dvw] lg:w-[100%] overflow-hidden md:pl-[30px] pr-[30px] pl-[20px] md:pr-[30px] lg:pl-[48px] mt-[100px] lg:mt-[100px] lg:pr-[40px]" >
                ...
                <div className='flex justify-between  pb-7'>
                    ...
                    }} className='text-[#9CFA4A] lg:p-2 flex justify-end px-[60px] lg:px-[150px] py-4 lg:py-4  items-end border border-1 border-[#9CFA4A2B]   bg-[#9CFA4A2B] '  onClick={initModal}>Add Profile</p>
                </div>
                ...
                <div className='bg-[#0E0E0E] '>
                    ...
                    <table className="table w-full pb-[60px] pt-[56px] mt-[56px] transform translate-x-2"  >
...
<div
 ...
 <div
        className={`h-full  items-center  w-[500px] rounded-lg lg:h-[854px] lg:w-[749px]  flex justify-center lg:justify-items-end bg-[#010101]  shadow-lg z-30 lg:backdrop-blur-md backdrop-blur-md fixed top-2 lg:top-4 right-8 lg:right-7 transform ${
        ...
        <div className="p-8">
          ...
          <div>
            ...
            <div className="flex  flex-col gap-11 ">
              <div className=" bg-[#0E0E0E] h-[80px] lg:h-[90px] flex flex-col justify-item p-4 lg:p-4 gap-3 w-[400px]">
